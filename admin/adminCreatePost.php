                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="container mb-5">
                                <div class="row subheader d-flex justify-content-center" style="margin-top: -50px;">
                                    Create Recipe Post
                                </div>
                            </div>
                            <div class="d-flex justify-content-center align-items-center" style="margin-top: -100px;">
                                <form action="../shared/processes/createRecipeQuery.php" method="POST"
                ...
                <div class="container-fluid tables-chart">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="margin-top: -100px;">
                                <form action="../shared/processes/createPostQuery.php" method="POST"
                                    enctype="multipart/form-data" class="w-100" style="max-width: 800px;">
                                    ...
                                    <div class="mb-3 mx-5">
                                        <div class="d-flex justify-content-center my-5">
                                            <button type="submit" name="postSubmit" class="btn btn-create">CREATE
                                                GALLERY POST</button>
                                        </div>
                                    </div>
                                </form>

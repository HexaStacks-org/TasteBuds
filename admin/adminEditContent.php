...
include("shared/process/editContentProcess.php");
?>
...
<head>
    ...
    <link rel="stylesheet" href="../admin/shared/assets/css/editContent.css" />
                    ...
                    <div class="row">
                        <div class="col-12">
                                                        ...
                                                        <div class="item-list mb-3" id="uploaded-gallery">
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="shared/components/editAdminContentRecipe.php?recipeID=<?php echo $rowUserUpContentRcIndividual['recipeID']; ?>"
                                                                ...
                                                                <div
                                                                    class="col-1 d-flex align-items-center justify-content-center">
                                                                    <button class="btn btn-link p-0 text-danger mb-1"
                                                    ...
                                                    while ($rowUserUpContentGpIndividual = mysqli_fetch_assoc($resultUserUpContentGpIndividual)) {
                                                        ...
                                                        <div class="item-list mb-3" id="uploaded-gallery">
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <div
                                                                    class="col-1 d-flex align-items-center justify-content-center">
                                                                    <a href="shared/components/editAdminContentGallery.php?postID=<?php echo $rowUserUpContentGpIndividual['postID']; ?>"
                                                                        class="btn btn-link p-0 me-2" title="Edit">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                            height="16" fill="currentColor" class="bi bi-pencil"
                                                                            viewBox="0 0 16 16">
                            ...
                            <div class="modal fade" id="deleteGalleryModal" tabindex="-1"
                                aria-labelledby="deleteGalleryModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteGalleryModalLabel">Delete Gallery Post
                                            </h5>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST">
                                                ...
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Cancel</button>
                                                <button type="submit" name="btnDeleteRecipe"
                                                    class="btn btn-danger">Delete</button>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <script>
                                const deleteRecipeButtons = document.querySelectorAll('[data-bs-toggle="modal"][data-bs-target="#deleteRecipeModal"]');

                                deleteRecipeButtons.forEach(button => {
                                    button.addEventListener('click', () => {
                                        const recipeID = button.getAttribute('data-recipeid');
                                        document.getElementById('recipeID').value = recipeID; // Set the ID in the hidden input field
                                    });
                                });

                                // For deleting a gallery post
                                const deleteGalleryButtons = document.querySelectorAll('[data-bs-toggle="modal"][data-bs-target="#deleteGalleryModal"]');

                                deleteGalleryButtons.forEach(button => {
                                    button.addEventListener('click', () => {
                                        const galleryID = button.getAttribute('data-galleryid');
                                        document.getElementById('galleryID').value = galleryID; // Set the ID in the hidden input field
                                    });
                                });
                            </script>
                        </div>

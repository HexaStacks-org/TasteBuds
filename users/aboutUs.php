            ...
            <div class="col-md-4">
                <div class="profile-card">
                    <div class="profile-image">
                        ...
                        <img src="../shared/assets/image/team-image/castillo.jpg" alt="Jomari Castillo"
                            class="img-fluid">
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="profile-card">
                    <div class="profile-image">
                        <img src="../shared/assets/image/team-image/marajas.jpg" alt="Jomari Castillo"
                            class="img-fluid">
                    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="profile-card">
                    <div class="profile-image">
                        <img src="../shared/assets/image/team-image/uriarte.jpg" alt="Jomari Castillo"
                            class="img-fluid">
                    </div>
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-md-4 mb-4">
                <div class="profile-card">
                    <div class="profile-image">
                        <img src="../shared/assets/image/team-image/vergara.jpg" alt="Jomari Castillo"
                            class="img-fluid">
                    </div>
                    <h5>Neil Vergara</h5>
                    <p>Fullstack Developer</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="profile-card">
                    <div class="profile-image">
                        <img src="../shared/assets/image/team-image/angeles.jpg" alt="Jomari Castillo"
                            class="img-fluid">
                    </div>
                    <h5>Vincent Angeles</h5>
                    <p>Fullstack Developer</p>
                    <p>Database Support Specialist</p>
                </div>
            </div>
        </div>
    </div>

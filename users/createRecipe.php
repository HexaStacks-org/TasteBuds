                    ...
                    <div class="recipe-form mx-3 my-3 px-5">
                        ...
                        <form action="../shared/processes/createRecipeQuery.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 mx-5">
                                ...
                                <textarea class="form-control py-3" id="description" name="description" rows="4" placeholder="Enter description of the recipe" required></textarea>
                            </div>
                            ...
                            <div class="categories mx-5 align-items-center">
                                ...
                                <div class="form-check-container mx-5">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioPrimary" id="flexRadioDefault1" value="1">
                                        <label class="form-check-label" for="flexRadioDefault1">Breakfast</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioPrimary" id="flexRadioDefault2" value="2">
                                        <label class="form-check-label" for="flexRadioDefault2">Lunch</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioPrimary" id="flexRadioDefault3" value="3">
                                ...
                                <div class="form-check-container mx-5">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault6" value="1">
                                        <label class="form-check-label" for="flexRadioDefault6">Vegan</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault7" value="2">
                                        <label class="form-check-label" for="flexRadioDefault7">Pork</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault8" value="3">
                                        <label class="form-check-label" for="flexRadioDefault8">Chicken</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault9" value="4">
                                        <label class="form-check-label" for="flexRadioDefault9">Beef</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault10" value="5">
                                        <label class="form-check-label" for="flexRadioDefault10">Seafood</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSecondary" id="flexRadioDefault11" value="6">
                            ...
                            <div class="mb-3 mx-5">
                                ...
                                <textarea class="form-control py-3" id="ingredients" name="ingredients" rows="6" placeholder="Enter ingredients of the recipe" required></textarea>
                            </div>
